...
-- [回答]
 SELECT  store_name, goods_name, quanity
 FROM stock_table 
 JOIN store_table 
...
-- [回答]
 SELECT store_code
 FROM stock_table
 WHERE quanity > (SELECT AVG(quanity) FROM stock_table WHERE store_code = 'EA01');
